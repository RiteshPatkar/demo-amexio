...
var RinaHomeComponent = /** @class */ (function () {
    ...
    RinaHomeComponent.prototype.setDefaultInfo = function () {
        this.infoMsg = " From 1 October 2018 GIC's card payment fee structure changed. A separate card payment fee now applies for each card type, with fees limited to the amount it costs GIC to accept payments made using each card. If you pay by debit card, payments may incur a fee of 0.26%\n    for Visa or 0.32% for Mastercard. If you pay by credit card, payments may incur a fee of 0.60% for Visa or 0.72% for Mastercard. If you pay at an Australia Post outlet, a card payment fee of 0.49% (incl GST) may apply.";
    };
...
module.exports = __webpack_require__(/*! /home/deepali/Docker-Containers/POC_RINA/gic-rina-v2.0/gic-rina/projects/rinaorigin/src/main.ts */"./src/main.ts");
